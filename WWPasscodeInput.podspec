...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of WWPasscodeInput.'
...
WWPasscodeInput is a customisable number passcode view written in Swift.
  ...
  s.homepage         = 'https://github.com/nick@thewhitewood.com/WWPasscodeInput'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nick@thewhitewood.com' => 'nick@thewhitewood.com' }
  s.source           = { :git => 'https://github.com/nick@thewhitewood.com/WWPasscodeInput.git', :tag => s.version.to_s }
